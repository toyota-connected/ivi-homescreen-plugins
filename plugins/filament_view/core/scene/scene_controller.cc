...
void SceneController::setUpCamera() {
  ...
  // Note right now cameraManager creates a default camera on startup; if we're immediately
  // setting it to a different one; that's extra work that shouldn't be done. Backlogged
