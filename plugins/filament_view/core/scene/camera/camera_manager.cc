...
void CameraManager::setCameraLookat(filament::math::float3 eye, filament::math::float3 center
, filament::math::float3 up)
{
  if(camera_ == NULL)
  {
    SPDLOG_DEBUG("Unable to set Camera Lookat, camera is null {} {} {}", __FILE__, __FUNCTION__, __LINE__);
    return;
  }
