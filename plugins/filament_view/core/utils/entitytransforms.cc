...
filament::math::mat3f EntityTransforms::identity3x3() {
  return filament::math::mat3f(filament::math::float3(1.0f, 0.0f, 0.0f),
                               filament::math::float3(0.0f, 1.0f, 0.0f),
                               filament::math::float3(0.0f, 0.0f, 1.0f));
}

filament::math::mat4f EntityTransforms::identity4x4() {
  return filament::math::mat4f(filament::math::float4(1.0f, 0.0f, 0.0f, 0.0f),
...
filament::math::mat3f EntityTransforms::QuaternionToMat3f(
  ...
  return filament::math::mat3f(
      filament::math::float3(1.0f - 2.0f * (yy + zz), 2.0f * (xy + wz),
                             2.0f * (xz - wy)),
...
void EntityTransforms::vApplyScale(std::shared_ptr<utils::Entity> poEntity,
...
void EntityTransforms::vApplyRotation(std::shared_ptr<utils::Entity> poEntity,
                                      filament::math::quatf rotation) {
  auto engine = CustomModelViewer::Instance(__FUNCTION__)->getFilamentEngine();
  vApplyRotation(poEntity, rotation, engine);
}

void EntityTransforms::vApplyTranslate(std::shared_ptr<utils::Entity> poEntity,
                                       filament::math::float3 translation) {
  auto engine = CustomModelViewer::Instance(__FUNCTION__)->getFilamentEngine();
  vApplyTranslate(poEntity, translation, engine);
}

void EntityTransforms::vApplyTransform(std::shared_ptr<utils::Entity> poEntity,
...
void EntityTransforms::vApplyShear(std::shared_ptr<utils::Entity> poEntity,
                                   filament::math::float3 shear) {
  auto engine = CustomModelViewer::Instance(__FUNCTION__)->getFilamentEngine();
...
void EntityTransforms::vResetTransform(
    std::shared_ptr<utils::Entity> poEntity) {
  auto engine = CustomModelViewer::Instance(__FUNCTION__)->getFilamentEngine();
...
void EntityTransforms::vApplyLookAt(std::shared_ptr<utils::Entity> poEntity,
