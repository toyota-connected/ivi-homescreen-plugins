...
//
// See
// https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams.
enum class FileChooserMode {
  // Open single file and requires that the file exists before allowing the
  // user to pick it.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams#MODE_OPEN.
  open = 0,
  // Similar to [open] but allows multiple files to be selected.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams#MODE_OPEN_MULTIPLE.
  openMultiple = 1,
  // Allows picking a nonexistent file and saving it.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams#MODE_SAVE.
  save = 2
};
...
//
// See
// https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel.
enum class ConsoleMessageLevel {
  // Indicates a message is logged for debugging.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#DEBUG.
  debug = 0,
  // Indicates a message is provided as an error.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#ERROR.
  error = 1,
  // Indicates a message is provided as a basic log message.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#LOG.
  log = 2,
  // Indicates a message is provided as a tip.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#TIP.
  tip = 3,
  // Indicates a message is provided as a warning.
  //
  // See
  // https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#WARNING.
  warning = 4,
...
class WebResourceResponseData {
 public:
  // Constructs an object setting all fields.
  explicit WebResourceResponseData(int64_t status_code);

  int64_t status_code() const;
  void set_status_code(int64_t value_arg);

 private:
  static WebResourceResponseData FromEncodableList(
      const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class InstanceManagerHostApi;
  friend class InstanceManagerHostApiCodecSerializer;
...
//
// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage
//
// Generated class from Pigeon that represents data sent in messages.
...
//
// See https://developer.cef.com/reference/cef/webkit/WebView.
//
// Generated class from Pigeon that represents Flutter messages that can be
// called from C++.
class WebViewFlutterApi {
 public:
  ...
  void Create(int64_t identifier,
              std::function<void(void)>&& on_success,
              std::function<void(const FlutterError&)>&& on_error);
  void OnScrollChanged(int64_t web_view_instance_id,
                       int64_t left,
                       int64_t top,
                       int64_t old_left,
                       int64_t old_top,
...
class WebViewClientFlutterApi {
 public:
  ...
  void OnPageFinished(int64_t instance_id,
                      ...
                      std::function<void(void)>&& on_success,
                      std::function<void(const FlutterError&)>&& on_error);
  void OnReceivedHttpError(int64_t instance_id,
                           int64_t web_view_instance_id,
                           const WebResourceRequestData& request,
                           const WebResourceResponseData& response,
                           std::function<void(void)>&& on_success,
                           std::function<void(const FlutterError&)>&& on_error);
...
class WebChromeClientHostApi {
 public:
  ...
  SetSynchronousReturnValueForOnConsoleMessage(int64_t instance_id,
                                               bool value) = 0;
  virtual std::optional<FlutterError> SetSynchronousReturnValueForOnJsAlert(
      int64_t instance_id,
      bool value) = 0;
  virtual std::optional<FlutterError> SetSynchronousReturnValueForOnJsConfirm(
      int64_t instance_id,
      bool value) = 0;
  virtual std::optional<FlutterError> SetSynchronousReturnValueForOnJsPrompt(
      int64_t instance_id,
      bool value) = 0;
...
class WebChromeClientFlutterApi {
 public:
  ...
  void OnConsoleMessage(int64_t instance_id,
                        ...
                        std::function<void(void)>&& on_success,
                        std::function<void(const FlutterError&)>&& on_error);
  void OnJsAlert(int64_t instance_id,
                 const std::string& url,
                 const std::string& message,
                 std::function<void(void)>&& on_success,
                 std::function<void(const FlutterError&)>&& on_error);
  void OnJsConfirm(int64_t instance_id,
                   const std::string& url,
                   const std::string& message,
                   std::function<void(bool)>&& on_success,
                   std::function<void(const FlutterError&)>&& on_error);
  void OnJsPrompt(int64_t instance_id,
                  const std::string& url,
                  const std::string& message,
...
// native class or an instance of the class.
//
// See https://developer.cef.com/reference/cef/webkit/PermissionRequest.
//
// Generated interface from Pigeon that represents a handler of messages from
// Flutter.
...
//
// See
// https://developer.cef.com/reference/cef/webkit/WebChromeClient.CustomViewCallback.
//
// Generated interface from Pigeon that represents a handler of messages from
// Flutter.
...
// overridden native class.
//
// See https://developer.cef.com/reference/cef/view/View.
//
// Generated class from Pigeon that represents Flutter messages that can be
// called from C++.
...
//
// See
// https://developer.cef.com/reference/cef/webkit/GeolocationPermissions.Callback.
//
// Generated interface from Pigeon that represents a handler of messages from
// Flutter.
...
// native class or an instance of the class.
//
// See https://developer.cef.com/reference/cef/webkit/HttpAuthHandler.
//
// Generated interface from Pigeon that represents a handler of messages from
// Flutter.
