...
int FileSink::configure(const libcamera::CameraConfiguration &config, const unsigned int texture_id)
{
...
void FileSink::map_buffer(FrameBuffer *buffer)
{
...
bool FileSink::process_request(Request *request)
{
